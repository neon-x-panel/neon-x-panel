...
const (
	panelUpdaterURL      = "https://raw.githubusercontent.com/neon-x-panel/NEON-X-PANEL/main/update.sh"
...
func fetchPanelRelease(tag string) (*service.Release, error) {
	url := "https://api.github.com/repos/neon-x-panel/NEON-X-PANEL/releases/latest"
	if tag != "" {
		url = "https://api.github.com/repos/neon-x-panel/NEON-X-PANEL/releases/tags/" + tag
	}
