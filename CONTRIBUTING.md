...
```bash
git clone https://github.com/neon-x-panel/NEON-X-PANEL.git
cd 3x-ui
...
- Bug reports and feature requests: [GitHub Issues](https://github.com/neon-x-panel/NEON-X-PANEL/issues)
