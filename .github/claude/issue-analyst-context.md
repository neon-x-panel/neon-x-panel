...
- Backend: Go 1.27, module `github.com/neon-x-panel/NEON-X-PANEL/v3`, Gin and GORM.
...
- Linux install: `bash <(curl -Ls https://raw.githubusercontent.com/neon-x-panel/NEON-X-PANEL/master/install.sh)`
...
- Docker image `ghcr.io/neon-x-panel/NEON-X-PANEL`; PostgreSQL profile
