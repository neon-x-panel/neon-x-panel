...
> tree rather than a pinned release (Go module `github.com/neon-x-panel/NEON-X-PANEL/v3`).
>
...
- **Module path is `.../v3`.** Internal imports use `github.com/neon-x-panel/NEON-X-PANEL/v3/internal/...`.
